    ...
    <div>
        <Header/>
            <Card className="max-w-240 p-8 m-auto mt-10">
                <h3 className="text-5xl">{language_sup.correct[lang as keyof typeof language_sup.correct]}</h3>
                <p className="text-4xl m-10">{language_sup.diploma[lang as keyof typeof language_sup.diploma]}</p>
                <Button
